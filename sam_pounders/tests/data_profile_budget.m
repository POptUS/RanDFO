function hl = data_profile_budget(H, effort, gate)
...
%       effort has the same dims as H and explicitly says how much effort
%       solver s took on problem p to return f. 
